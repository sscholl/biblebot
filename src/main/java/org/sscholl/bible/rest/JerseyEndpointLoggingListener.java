...
public class JerseyEndpointLoggingListener implements ApplicationEventListener {
    ...
    public JerseyEndpointLoggingListener withOptions() {
        this.withOptions = true;
        return this;
    }

    public JerseyEndpointLoggingListener withWadl() {
        this.withWadl = true;
        return this;
    }
    ...
    private Set<EndpointLogLine> getLinesFromResource(Resource resource) {
        ...
        populate("", false, resource, logLines);
        return logLines;
    }
